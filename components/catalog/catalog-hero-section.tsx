...
export const CatalogHeroSection = () => {
    return (
        <section className="catalog-hero after:absolute after:inset-0 after:bg-linear-to-t after:from-black/80 after:to-transparent relative overflow-hidden h-[50vh]">
