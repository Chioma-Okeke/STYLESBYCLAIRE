...
export const bookingPolicies = [
    {
        ...
        items: [
            ...
            "Remaining balance is cash or Zelle.",
        ],
    },
    {
        ...
        items: [
            ...
            "One reschedule is allowed with 48+ hours notice.",
        ],
    },
    {
        category: "Booking",
        items: [
            "Hair is included unless stated otherwise.",
            "Include your hair color of choice in the Appointment Notes when booking.",
            "DM your inspiration photo to @stylesbyclairee after booking.",
        ],
    },
    {
        category: "Appointment",
        items: [
            "$10 late fee applies after 15 minutes.",
            "No extra guests.",
            "Appointment details will be sent 24-48 hours before your appointment.",
        ],
    },
];

export const appointmentPrep = [
    "Please arrive with your hair clean, detangled and free from heavy products.",
    "Avoid using oils, gels, or edge control on your hair before your appointment.",
    "Hydrate, eat beforehand or bring your food along, and wear comfortable clothing — glam time can take a few hours!",
];
